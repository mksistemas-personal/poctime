...
public class ProductConstants {
    ...
    public static final String NAME_NOT_BLANK = "product.name.not.blank";
    ...
    public static final String NCM_NOT_BLANK = "product.ncm.not.blank";
    ...
    public static final String CST_IPI_NOT_FOUND = "cst.ipi.not.found";

...
@AllArgsConstructor
public class GetAllClientService implements GetAllBusinessUseCase<ClientSearchRequest, Maybe<Slice<ClientResponse>>> {

    private final ClientRepository clientRepository;

    @Override
    public Maybe<Slice<ClientResponse>> execute(Pageable pageable, @Nullable ClientSearchRequest request) {
        return Maybe.fromEval(later(() -> clientRepository.findBySearchRequest(request, pageable)))
